...
@XmlSubtype("hf prayed inside structure")
public class HfPrayedInsideStructure extends HfEvent implements SiteRelatedEvent, StructureRelatedEvent {
	@Xml("site,site_id")
	...
	public String getShortDescription() {
		...
		return hf + " prayed inside " + World.getStructure(structureId, siteId).getLink() + " in " + site;
	}
}
