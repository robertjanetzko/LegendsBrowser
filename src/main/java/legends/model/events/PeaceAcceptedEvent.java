...
@XmlSubtype("peace accepted")
public class PeaceAcceptedEvent extends Event implements EntityRelatedEvent, SiteRelatedEvent {
	@Xml("source")
	...
	public String getShortDescription() {
		...
		return destination + " accepted an offer of peace from " + source;
	}
